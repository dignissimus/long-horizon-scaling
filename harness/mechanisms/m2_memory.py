...
def m2_memory_solver(mechanism: 'M2Memory'):
    async def solve(state: TaskState, generate: Generate) -> TaskState:
        ...
        mem_prompt = (
            ...
            "Focus on recording established facts, state changes, and spatial relationships. "
            "CRITICAL: You must explicitly track your overarching long-term mission, your current active subgoal, and the next goals you plan to tackle. "
            "Never lose sight of the final objective just because you are working on a short-term task. "
